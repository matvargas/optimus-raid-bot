...
namespace RaidBot.Tools.CodeTraductor.Generator
{
    public class MessageGenerator
    {
        ...
        private void Generate()
        {
            ...
            Class.Members.Add(GenerateSerializeMethod("ICustomDataWriter"));
            Class.Members.Add(GenerateDeserializeMethod("ICustomDataReader"));
        ...
        private CodeMemberMethod GenerateInitMethod()
        {
            CodeMemberMethod retVal = new CodeMemberMethod();
            retVal.Name = "Initiate";
        ...
        private CodeTypeMember[] GenerateProperity()
        {
            ...
            ProtocolIdProperty.Name = "ProtocolId";
            ...
            ProtocolIdProperty.GetStatements.Add(new CodeMethodReturnStatement(new CodeVariableReferenceExpression("Id")));
