    ...
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            foreach (ParsingProfile parsingProfile in profiles)
            {
                ...
                {
                    if (file.Contains("NetworkDataContainer") || file.Contains("CharacterCreationRequestMessage"))
                    {
                    ...
                    File.WriteAllText(output, new FastConvert(contents, x == 2).Parsed.ToString());
                }
