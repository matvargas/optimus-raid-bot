package com.ankamagames.dofus.network.messages.game.chat
{
   ...
   public class ChatServerMessage extends ChatAbstractServerMessage implements INetworkMessage
   {
      ...
      public function initChatServerMessage(channel:uint = 0, content:String = "", timestamp:uint = 0, fingerprint:String = "", senderId:Number = 0, senderName:String = "", senderAccountId:uint = 0) : ChatServerMessage
      {
