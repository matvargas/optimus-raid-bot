package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightLifePointsLostMessage extends AbstractGameActionMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightLifePointsLostMessage(actionId:uint = 0, sourceId:Number = 0, targetId:Number = 0, loss:uint = 0, permanentDamages:uint = 0) : GameActionFightLifePointsLostMessage
      {
