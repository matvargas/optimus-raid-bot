package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightLifeAndShieldPointsLostMessage extends GameActionFightLifePointsLostMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightLifeAndShieldPointsLostMessage(actionId:uint = 0, sourceId:Number = 0, targetId:Number = 0, loss:uint = 0, permanentDamages:uint = 0, shieldLoss:uint = 0) : GameActionFightLifeAndShieldPointsLostMessage
      {
