...
namespace RaidBot.Engine.Utility.Security
{
    public static class Cryptography
    {
        ...
        public static byte[] Encrypt(byte[] key, string salt, byte[] aesKey, string username, string password)
        {
            List<byte> unsigned = key.ToList();
            ...
            byte[] credentials = SetCredentials(publicKey, validSalt, aesKey, username, password);
        ...
        private static byte[] SetCredentials(RSACryptoServiceProvider publickey, string salt, byte[] aesKey, string username, string password)
        {
