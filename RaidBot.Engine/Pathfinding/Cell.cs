   ...
   public class Cell
    {
        ...
        public List<int> GetConnectedCells()
        {
            ...
            list.Add(setFromCoords(Location.X - 1, Location.Y));
            list.Add(setFromCoords(Location.X - 1, Location.Y - 1));
            list.Add(setFromCoords(Location.X + 1, Location.Y ));
            list.Add(setFromCoords(Location.X  , Location.Y + 1));
            return list;
        }
        public int GetCellInDirection(DirectionsEnum direction, short step)
        {
            ...
            switch (direction)
            {
                ...
                return setFromCoords(ThatCell.X , ThatCell.Y);     
        }
